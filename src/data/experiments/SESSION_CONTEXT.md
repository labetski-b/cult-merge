...
## Часть 4: Kraken Reward Redesign ✅ ПРИМЕНЕНО

**Папка**: `4.kraken-reward-redesign/`
**Что сделано**: Устранена монотонность наград L20-L49. Контекстные награды привязанные к генераторам.

### Проблема
L20-L49: 90 одинаковых наград box7 — экстремальная монотонность.

### Решение
- 6 тематических зон по 5 уровней, все 7 типов боксов
- Jackpot-уровни на анлоках: L23 (Gen6), L28 (Gen7), L33 (Gen8)
- Средний шаг jackpot'а — гарантированная руна другого типа (box2/box6)
- box7 остаётся базой (55/90 = 61%)

### Ключевой инсайт
Нельзя полностью обнулять одну руну в jackpot-зоне другой — вероятностный box7 не гарантирует нужные руны. Решение: гарантированные box2/box6 в середине jackpot'ов.
...
- Все генераторы покупаются тик-в-тик с baseline
